...
export const SocialShareButtons = memo(function SocialShareButtons({ variant = "default" }: SocialShareButtonsProps) {
...
// WhatsApp icon component (extracted from inline SVG)
const WhatsAppIcon = () => (
